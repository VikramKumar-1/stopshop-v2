                  ...
                  <div className="p-4 flex-grow flex flex-col justify-between">
                    ...
                    <div className="flex gap-2 w-full">
                      ...
                      <button
                        ...
                        className="px-3 py-2 rounded-xl border border-bronze-500 text-bronze-500 dark:text-bronze-400 hover:bg-bronze-500/10 transition-all duration-200 flex items-center justify-center cursor-pointer shrink-0"
                        title="Add to Cart"
                      >
                      ...
                      <button
                        onClick={() => {
                          addToCart(item, 1);
                          router.push(item.slug ? `/checkout/${item.slug}-${item.id}` : `/checkout?productId=${item.id}`);
                        }}
                        className="flex-grow inline-flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-gradient-to-r from-bronze-500 to-bronze-600 hover:from-bronze-400 hover:to-bronze-500 text-white font-bold shadow-md shadow-bronze-500/10 text-[10px] sm:text-xs transition-all duration-300 active:scale-[0.97] cursor-pointer"
                      >
                        Buy Now
                      </button>
                    </div>
