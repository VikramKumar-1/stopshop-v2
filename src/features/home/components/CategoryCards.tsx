...
const categoryCards = [
  {
    ...
    link: "/category/kitchen-utility",
    linkText: "Explore all",
    items: [
      { name: "Brass Cookware", image: "/bronze-hero.png", href: "/category/brass-cookware" },
      { name: "Copper Products", image: "/bronze-lota.png", href: "/category/copper-products" },
      { name: "Steel Essentials", image: "/collection-tableware.png", href: "/category/steel-essentials" },
      { name: "Kitchen Racks", image: "/bronze-kadai.png", href: "/category/kitchen-racks" },
    ],
  },
  {
    title: "Home & Living",
    ...
    linkText: "See more",
    items: [
      { name: "Home Living", image: "/bronze-hero.png", href: "/category/home-living" },
      { name: "Bedroom", image: "/collection-tableware.png", href: "/category/bedroom" },
      { name: "Living Room", image: "/bronze-hero.png", href: "/category/living-room" },
      { name: "Handicrafts", image: "/bronze-kadai.png", href: "/category/handicrafts" },
    ],
  },
  {
    title: "Spiritual & Gifting",
    link: "/category/pooja-collection",
    linkText: "Explore all",
    items: [
      { name: "Pooja Collection", image: "/collection-pooja.png", href: "/category/pooja-collection" },
      { name: "Gifting Sets", image: "/collection-tableware.png", href: "/category/gifting" },
      { name: "Drinkware", image: "/bronze-lota.png", href: "/category/drinkware" },
      { name: "Decor Items", image: "/bronze-hero.png", href: "/category/handicrafts" },
    ],
  },
  {
    title: "Trending Now",
    ...
    linkText: "See more",
    items: [
      { name: "Brass Dinner Sets", image: "/collection-tableware.png", href: "/category/brass-cookware" },
      { name: "Copper Bottles", image: "/bronze-lota.png", href: "/category/copper-products" },
      { name: "Bronze Kadai", image: "/bronze-kadai.png", href: "/category/kitchen-utility" },
      { name: "Artisan Decor", image: "/bronze-hero.png", href: "/category/handicrafts" },
    ],
  },
];
