    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-surface-card border border-border p-8 rounded-3xl shadow-xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-display font-bold text-heading">Register as Artisan Vendor</h1>
          <p className="text-xs text-muted">Join StopShop's export network and list your handmade copperware & bronze cookware.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold text-muted uppercase tracking-wider">Full Name / Workshop Name</label>
            <div className="relative">
              <input
                ...
                placeholder="e.g. Moradabad Metal Craft House"
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <input
                ...
                placeholder="workshop@stopshop.com"
                className="w-full bg-surface border border-border focus:border-orange-500 rounded-xl pl-10 pr-4 py-2.5 text-xs text-heading focus:outline-none"
              />
          ...
          >
            {loading ? "Creating Account..." : "Register Workshop Account"}
          </button>
        ...
        <div className="border-t border-border pt-4 text-center">
          <p className="text-xs text-muted">
            Already registered?{" "}
            <Link href="/vendor/login" className="text-orange-500 font-bold hover:underline inline-flex items-center gap-0.5">
              Sign In Here
              <ArrowRight size={12} />
            </Link>
          </p>
