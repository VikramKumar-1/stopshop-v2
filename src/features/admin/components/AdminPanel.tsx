...
export const AdminPanel = () => {
  ...
  const handleSavePlatformSettings = async (e: React.FormEvent) => {
     ...
     try {
        const { defaultCommissionRate, taxRate, commissionGstRate, commissionSacCode, shippingFreeAbove, shippingChargePaise, codShippingChargePaise, internationalShippingPaise, codMaxAmountPaise, returnWindowDays, vendorReturnSlaHours, payoutSchedule, payoutCustomDays, codEnabled, returnEnabled, shiprocketAutoAssign, invoiceTemplate, shippingPolicy, refundPolicy, privacyPolicy, termsPolicy, seoTitle, seoDescription, seoKeywords, seoCategoryTitleTemplate, seoCategoryDescTemplate, seoMaterialTitleTemplate, seoMaterialDescTemplate, seoMaterialCategoryTitleTemplate, seoMaterialCategoryDescTemplate } = settings;
        const res = await fetch("/api/admin/settings", {
           method: "PATCH",
           headers: { "Content-Type": "application/json" },
           body: JSON.stringify({ defaultCommissionRate, taxRate, commissionGstRate, commissionSacCode, shippingFreeAbove, shippingChargePaise, codShippingChargePaise, internationalShippingPaise, codMaxAmountPaise, returnWindowDays, vendorReturnSlaHours, payoutSchedule, payoutCustomDays, codEnabled, returnEnabled, shiprocketAutoAssign, invoiceTemplate, shippingPolicy, refundPolicy, privacyPolicy, termsPolicy, seoTitle, seoDescription, seoKeywords, seoCategoryTitleTemplate, seoCategoryDescTemplate, seoMaterialTitleTemplate, seoMaterialDescTemplate, seoMaterialCategoryTitleTemplate, seoMaterialCategoryDescTemplate })
        });
